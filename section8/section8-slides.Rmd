...
Go to useful links and click on http://stringr.tidyverse.org. There you will find a link to the *cheatsheet* for ``stringr``.
...
Again, you should also check out the ``stringr`` cheatsheet (page 2)!
