...
Put the code into the follwing R chunk. To evaluate the expression click 
...
Hint: Create a chracter variable with this sentence and then use the ``nchar`` function.
...
Use ``month.abb`` to get the month abrreviations.
