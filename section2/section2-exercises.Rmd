...
Use the ``readline()`` function and its ``promt`` argument.
...
**First, click on the "Preview" dropdown, go to "Knit Directory" and select "Project Directory"**
*You should always do that if you want to read in data files fromt the data folder!*
...
in the "Evironment" pane (default: top right).
